...
if (nexacro._Browser == "Runtime") {
	if (!nexacro._init_platform_runtime) {
		...
		nexacro._syshandler_ondragenter_forward = function (_window, elem, fromElem, strButton, altKey, ctrlKey, shiftKey, windowX, windowY, screenX, screenY, offsetX, offsetY) {
			_window._on_sys_dragenter(elem, fromElem, strButton, altKey, ctrlKey, shiftKey, windowX, windowY, screenX, screenY, offsetX, offsetY);
		};
